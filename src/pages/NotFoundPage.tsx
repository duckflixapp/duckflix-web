...
export default function NotFoundPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-6 text-center overflow-hidden relative">
            ...
            <h1 className="text-[160px] md:text-[280px] font-black text-white/3 leading-none absolute select-none tracking-tighter italic">
                404
            </h1>

            {/* GLOSSY CARD */}
            <div className="relative z-10 backdrop-blur-xs bg-white/1 border border-white/10 p-8 md:p-12 rounded-[42px] shadow-2xl max-w-2xl mx-auto overflow-hidden group">
                ...
                <p className="text-text/60 text-md max-w-md mb-10 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-20">
                    <button
                        onClick={() => navigate(-1)}
                        className="flex items-center justify-center gap-3 px-8 md:py-4 py-3 bg-white/5 hover:bg-white/10 text-white rounded-4xl border border-white/10 transition-all duration-300 backdrop-blur-md group"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-3 px-8 md:py-4 py-3 bg-primary cursor-pointer hover:bg-primary/90 text-background font-medium rounded-4xl shadow-[0_0_20px_rgba(var(--primary-color),0.3)] hover:shadow-[0_0_30px_rgba(var(--primary-color),0.5)] transition-all duration-300"
                    >
                        <Compass size={20} />
